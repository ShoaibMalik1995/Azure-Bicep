...
param envShort string = 'prod'
param location string = resourceGroup().location
// App Service Plan and App Service
param appServicePlanName string = 'msk-appserviceplan-uks-${envShort}'
param webAppName string = 'msk-webapp-uks-${envShort}'

// Application Insights
param appInsightsName string = 'msk-appinsights-uks-${envShort}'

// SQL Database and SQL Server
param sqlServerName string = 'msk-sqlserver-uks-${envShort}'
param sqlDatabaseName string = 'msk-sqldatabase-uks-${envShort}'
